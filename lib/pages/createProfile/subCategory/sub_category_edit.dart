...
class SubCategoryEditPage extends StatelessWidget {
  int id;
  SubCategoryEditPage(this.id);
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    (subCategoryCubit.subCategories.isEmpty)
                        ? Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, pos) {
                                SubCategoryItem item =
                                    subCategoryCubit.subCategories[pos];
                                return Card(
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: (subCategoryCubit.subCategories.isEmpty)
                        ? MaterialButton(
                            height: 48,
                            elevation: 0,
                        ...
                        : Row(
                            children: [
                              ...
                              Expanded(
                                child: Button(
                                  onPressed: () {
                                    Navigation.instance.navigate("/serviceEdit",
                                        args: subCategoryCubit
                                                .subCategories[subCategoryCubit
                                                    .currentIndex]
                                                .id ??
                                            0);
                                  },
